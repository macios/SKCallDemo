...
//  SKCallDemo
//
//  Created by 松云 on 2019/2/26.
//  Copyright © 2019年 SK_HU. All rights reserved.
//

#import "ViewController.h"
#import "SKCallManager.h"

@interface ViewController ()

@property (weak, nonatomic) IBOutlet UITextField *phoneText;
@property (weak, nonatomic) IBOutlet UITextField *indtifierText;
@property (nonatomic, strong) SKCallManager *manager;
...
- (void)viewDidLoad {
    ...
    self.manager = [[SKCallManager alloc] initWithExtensionIdentifier:@"mark.callTest.callPhoneTest"
                                                    ApplicationGroupIdentifier:@"group.tio.calltest"];
}
